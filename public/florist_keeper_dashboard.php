...
<head>
    <meta charset="UTF-8">
    <title>Florist Keeper Dashboard</title>
...
<div class="d-flex">
    ...
    <main class="flex-grow-1">
        <header class="border-bottom px-4 py-3 d-flex justify-content-between align-items-center">
            <div>
                <h2 class="h5 mb-0">Florist keeper dashboard</h2>
                <p class="text-muted small mb-0">
                    Focused view for daily sales of flowers, bouquets and vases.
                </p>
            </div>
            <div class="dropdown">
        ...
        <section class="p-4">
            <div class="row g-3 mb-4">
                <div class="col-md-4">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body">
                            <p class="text-muted small mb-1">Your florist sales today</p>
                ...
                <div class="col-md-4">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body">
                            <p class="text-muted small mb-1">Pending bouquet ideas</p>
                            <h3 class="h4 mb-0">0</h3>
                        </div>
                    </div>
                </div>
            ...
            <div class="card border-0 shadow-sm mb-3">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div>
                        <h5 class="card-title mb-1">Start a new floral sale</h5>
                        <p class="text-muted small mb-0">
                            Open the florist POS screen to register a bouquet or single-stem sale.
                        </p>
                    </div>
                    <a href="#" class="btn btn-primary btn-sm">Open florist POS</a>
                </div>
            </div>
        </section>
    </main>
