...
<div class="d-flex">
    <nav class="sidebar p-3">
        <h1 class="h5 fw-semibold mb-4">Florist POS</h1>
    ...
    <main class="flex-grow-1">
        <header class="border-bottom px-4 py-3 d-flex justify-content-between align-items-center">
            <div>
                <h2 class="h5 mb-0">Florist admin dashboard</h2>
                <p class="text-muted small mb-0">
                    Monitor sales, stock, wastage and bouquet performance.
                </p>
            </div>
            <div class="dropdown">
        ...
        <section class="p-4">
            <div class="row g-3 mb-4">
                <div class="col-md-3">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body">
                            <p class="text-muted small mb-1">Today’s florist sales</p>
                ...
                <div class="col-md-3">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body">
                            <p class="text-muted small mb-1">Bouquets sold this week</p>
                ...
                <div class="col-md-3">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body">
                            <p class="text-muted small mb-1">Wastage this month</p>
                            <h3 class="h4 mb-0">0.00</h3>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body">
                            <p class="text-muted small mb-1">Active florist products</p>
                            <h3 class="h4 mb-0">0</h3>
                        </div>
                    </div>
                </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <h5 class="card-title mb-3">Florist analytics (placeholder)</h5>
                    <p class="text-muted small mb-0">
                        Charts for weekly, monthly and yearly florist sales, most popular bouquets, and occasion-based
